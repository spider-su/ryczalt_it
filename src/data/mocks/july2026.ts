...
export const july2026Invoices: Invoice[] = [
  { id: 'income-1', title: 'Acme Sp. z o.o.', subtitle: 'FV 5/2026 · 31 Jul', amount: { amount: '16250.00', currency: 'PLN' }, direction: 'SALE', counterparty: 'Acme Sp. z o.o.', legalName: 'Acme Sp. z o.o.', alias: null, taxIdentifier: null, documentNumber: 'FV 5/2026', issueDate: '2026-07-31', currency: 'PLN', importStatus: 'IMPORTED', approvalStatus: 'APPROVED', approvalSource: 'MANUAL', paymentVerificationPolicy: 'REQUIRED', paymentStatus: 'MATCHED', source: 'KSeF', category: null, sourceType: 'KSEF' },
  { id: 'cost-1', title: 'BP Europa', subtitle: 'Fuel · 2 Jul', amount: { amount: '828.33', currency: 'PLN' }, direction: 'PURCHASE', counterparty: 'BP Europa', legalName: 'BP Europa', alias: null, taxIdentifier: null, documentNumber: 'FV/7/2026', issueDate: '2026-07-02', currency: 'PLN', importStatus: 'IMPORTED', approvalStatus: 'APPROVED', approvalSource: 'COUNTERPARTY_RULE', paymentVerificationPolicy: 'NOT_REQUIRED', paymentStatus: 'NOT_REQUIRED', source: 'UPLOAD', category: 'FUEL', sourceType: 'UPLOAD' }
];
...
export const july2026: AccountingPeriod = {
  ...
  documents: { invoiceCount: 2, transactionCount: 2 }, settlement: { expectedCount: 3, paidCount: 0, outstandingCount: 3, totalExpected: { amount: '10843.04', currency: 'PLN' }, totalPaid: { amount: '0.00', currency: 'PLN' }, totalOutstanding: { amount: '10843.04', currency: 'PLN' }, fullySettled: false },
  reconciliation: { rowCount: 2, settledCount: 2, mismatchCount: 0, missingEvidenceCount: 0, state: 'healthy' }, completeness: { status: 'COMPLETE', blockingIssueCount: 0 }, allowedActions: ['SETTLE'], invoices: july2026Invoices, transactions: [], obligations: july2026Obligations, issues: []
};
