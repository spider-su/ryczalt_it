...
export type InvoiceDto = { id: number | string; direction: string; reference: string | null; issueDate: string | null; accountingDate: string | null; netAmount: Decimal | null; vatAmount: Decimal | null; grossAmount: Decimal | null; currency: string | null; bookedNetPln: Decimal | null; ryczaltRate: Decimal | null; deductibleVat: Decimal | null; classification: string | null; counterparty: { id: number | string; legalName: string; alias: string | null; taxIdentifier: string | null } | null; approvalStatus: string | null; approvalMethod: string | null; paymentVerificationPolicy: string | null; paymentStatus: string | null; sourceType: string | null; sourceReference: string | null };
