...
export type Calculation = { type: string; status: string; amount: Money };
...
export type AccountingPeriod = {
  ...
  completeness: { status: string; blockingIssueCount: number }; calculations: Calculation[]; allowedActions: string[]; invoices: Invoice[]; transactions: Transaction[]; obligations: Obligation[]; issues: AccountingIssue[];
};
